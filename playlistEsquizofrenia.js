...
export function PlaylistEsquizo() {
        ...
        <View style={ESTILO.etapa}>
          ...
          <View style={ESTILO.boxEtapa}>
            <View style={ESTILO.divsaoEtapa}>
              ...
              <Image source={require("./assets/iconeRoupaEsquizo.png")} style={ESTILO.imgetapa} />
            </View>
          </View>
        </View>
      </View>
        ...
        <View style={ESTILO.etapa}>
          ...
          <View style={ESTILO.boxEtapa}>
            <View style={ESTILO.divsaoEtapa}>
              ...
              <Image source={require("./assets/iconeBeberEsquizo.png")} style={ESTILO.imgetapa} />
            </View>
          </View>
        </View>
      </View>
        ...
        <View style={ESTILO.etapa}>
          ...
          <View style={ESTILO.boxEtapa}>
            <View style={ESTILO.divsaoEtapa}>
              ...
              <Image source={require("./assets/iconeLinkEsquizo.png")} style={ESTILO.imgetapa} />
            </View>
          </View>
        </View>
      </View>
