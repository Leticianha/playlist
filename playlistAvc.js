        ...
        <View style={ESTILO.etapa}>
          ...
          <View style={ESTILO.boxEtapa}>
            <View style={ESTILO.divsaoEtapa}>
              ...
              <Image source={require("./assets/iconeRoupaAvc.png")} style={ESTILO.imgetapa} />
            </View>
          </View>
        </View>
      </View>
        ...
        <View style={ESTILO.etapa}>
          ...
          <View style={ESTILO.boxEtapa}>
            <View style={ESTILO.divsaoEtapa}>
              ...
              <Image source={require("./assets/iconeBeberAvc.png")} style={ESTILO.imgetapa} />
            </View>
          </View>
        </View>
      </View>
        ...
        <View style={ESTILO.etapa}>
          ...
          <View style={ESTILO.boxEtapa}>
            <View style={ESTILO.divsaoEtapa}>
              ...
              <Image source={require("./assets/iconeLinkAvc.png")} style={ESTILO.imgetapa} />
            </View>
          </View>
        </View>
      </View>
