...
export function PlaylistAlzhaimer() {
        ...
        <View style={ESTILO.etapa}>
          ...
          <View style={ESTILO.boxEtapa}>
            <View style={ESTILO.divsaoEtapa}>
              ...
              <Image source={require("./assets/iconeRoupaAlzhaimer.png")} style={ESTILO.imgetapa} />
            </View>
          </View>
        </View>
      </View>
        ...
        <View style={ESTILO.etapa}>
          ...
          <View style={ESTILO.boxEtapa}>
            <View style={ESTILO.divsaoEtapa}>
              ...
              <Image source={require("./assets/iconeBeberAlzhaimer.png")} style={ESTILO.imgetapa} />
            </View>
          </View>
        </View>
      </View>
        ...
        <View style={ESTILO.etapa}>
          ...
          <View style={ESTILO.boxEtapa}>
            <View style={ESTILO.divsaoEtapa}>
              ...
              <Image source={require("./assets/iconeLinkAlzhaimer.png")} style={ESTILO.imgetapa} />
            </View>
          </View>
        </View>
      </View>
